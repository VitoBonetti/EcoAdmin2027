...
export default function EntryViewModal({ isOpen, entryId, onClose, onEdit }: EntryViewModalProps) {
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          {isLoading || !data ? (
            ...
            <div className="space-y-8">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800 text-gray-700 dark:text-gray-300">
                      {data.products.map((prod: any) => (
                        <tr key={prod.id}>
                          ...
                          <td className="p-3">{prod.unity}</td>
              ...
              <div className="flex justify-end">
                <div className="w-full md:w-1/3 space-y-3 bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-100 dark:border-gray-800 text-sm">
        ...
        <div className="p-6 border-t border-gray-100 dark:border-gray-800 flex justify-between bg-gray-50 dark:bg-gray-800/20">
          ...
          <div className="flex gap-3">
            <button onClick={handleDownloadPDF} disabled={!data} className="flex items-center gap-2 px-6 py-2 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-medium rounded-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors disabled:opacity-50">
